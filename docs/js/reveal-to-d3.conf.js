...
function removeSVGs() {
  ...
  d3.select("#barchart-slide #summary div").remove()
  d3.select("#barchart-slide #barchart div").remove()
  d3.select("#barchart-slide #barchart select").remove()
